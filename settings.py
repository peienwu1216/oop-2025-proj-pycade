...
# 格子移動動畫持續時間 (秒)
HUMAN_GRID_MOVE_ACTION_DURATION = 0.15 
AI_GRID_MOVE_ACTION_DURATION = 0.3   # AI 移動可以慢一點，方便觀察
...
# AI Settings
AI_MOVE_DELAY = 200       
AI_PLAYER_SPEED_FACTOR = 0.5 # 已不再使用，AI移動基於格子和 ACTION_ANIMATION_DURATION
